...
public class ColorSignatureHausdorff extends FeatureFactory
{

	public ColorSignatureHausdorff(Settings settings) {
		super(settings);
	}
	...
	public float getDistance(float[] fv1, float[] fv2) {
		...
		return hausdorffMetric.getDistance();		
	}

	@Override
	public String getName() {
		return "ColorSignatureHausdorff";
	}
}
